...
object ExternalSecretsOperator extends Resource[
  ...
  override def make(inputParams: ExternalSecretsOperatorInput)(using Context): Output[ExternalSecretsOperatorOutput] =
    for {
  ...
  override def makeLocal(inputParams: ExternalSecretsOperatorInput)(using Context): Output[ExternalSecretsOperatorOutput] =
    make(inputParams)

  private def createNamespace(params: ExternalSecretsOperatorInput)(using Context): Output[k8s.core.v1.Namespace] =
